...
%%%considered
function [Decision,SortedR,AvaiChanal,row,Trans] = SmallestFirst(D,R,S,SA)
    ...
    if(isempty(find(SA(:,t)==0))==0)
        ...
        %determine which node has the smallest packet size
        SortedR=sortrows(R,3);%sort request R according to packet size
